...
type: project
title: "Dawn: Sensing for a closed-loop, wearable intervention for compulsive body-focused behaviors"
...
.project-link-icon {
  ...
  color: var(--text-primary, #2c2d2a) !important;
  transition: background 0.2s ease !important;
}
.project-link-icon:hover {
  background: var(--border-subtle, #f1f5f1) !important;
}
...
<div class="project-links">
  <a class="project-link-icon" href="https://x.com/elainexliu/status/2094927702323233274" target="_blank" rel="noopener" aria-label="View on X">
    <svg viewBox="0 0 1200 1227" width="18" height="18" aria-hidden="true"><path d="M714.163 519.284L1160.89 0H1055.03L667.137 450.887L357.328 0H0L468.492 681.821L0 1226.37H105.866L515.491 750.218L842.672 1226.37H1200L714.137 519.284H714.163ZM569.165 687.828L521.697 619.934L144.011 79.6944H306.615L611.412 515.685L658.88 583.579L1055.08 1150.3H892.476L569.165 687.854V687.828Z"/></svg>
  </a>
  <a class="project-link-icon" href="https://github.com/elainexliu/dawn" target="_blank" rel="noopener" aria-label="View on GitHub">
    <svg viewBox="0 0 496 512" width="18" height="18" aria-hidden="true"><path d="M165.9 397.4c0 2-2.3 3.6-5.2 3.6-3.3.3-5.6-1.3-5.6-3.6 0-2 2.3-3.6 5.2-3.6 3-.3 5.6 1.3 5.6 3.6zm-31.1-4.5c-.7 2 1.3 4.3 4.3 4.9 2.6 1 5.6 0 6.2-2s-1.3-4.3-4.3-5.2c-2.6-.7-5.5.3-6.2 2.3zm44.2-1.7c-2.9.7-4.9 2.6-4.6 4.9.3 2 2.9 3.3 5.9 2.6 2.9-.7 4.9-2.6 4.6-4.6-.3-1.9-3-3.2-5.9-2.9zM244.8 8C106.1 8 0 113.3 0 252c0 110.9 69.8 205.8 169.5 239.2 12.8 2.3 17.3-5.6 17.3-12.1 0-6.2-.3-40.4-.3-61.4 0 0-70 15-84.7-29.8 0 0-11.4-29.1-27.8-36.6 0 0-22.9-15.7 1.6-15.4 0 0 24.9 2 38.6 25.8 21.9 38.6 58.6 27.5 72.9 20.9 2.3-16 8.8-27.1 16-33.7-55.9-6.2-112.3-14.3-112.3-110.5 0-27.5 7.6-41.3 23.6-58.9-2.6-6.5-11.1-33.3 2.6-67.9 20.9-6.5 69 27 69 27 20-5.6 41.5-8.5 62.8-8.5s42.8 2.9 62.8 8.5c0 0 48.1-33.6 69-27 13.7 34.7 5.2 61.4 2.6 67.9 16 17.7 25.8 31.5 25.8 58.9 0 96.5-58.9 104.2-114.8 110.5 9.2 7.9 17 22.9 17 46.4 0 33.7-.3 75.4-.3 83.6 0 6.5 4.6 14.4 17.3 12.1C428.2 457.8 496 362.9 496 252 496 113.3 383.5 8 244.8 8zM97.2 352.9c-1.3 1-1 3.3.7 5.2 1.6 1.6 3.9 2.3 5.2 1 1.3-1 1-3.3-.7-5.2-1.6-1.6-3.9-2.3-5.2-1zm-10.8-8.1c-.7 1.3.3 2.9 2.3 3.9 1.6 1 3.6.7 4.3-.7.7-1.3-.3-2.9-2.3-3.9-2-.6-3.6-.3-4.3.7zm32.4 35.6c-1.6 1.3-1 4.3 1.3 6.2 2.3 2.3 5.2 2.6 6.5 1 1.3-1.3.7-4.3-1.3-6.2-2.2-2.3-5.2-2.6-6.5-1zm-11.4-14.7c-1.6 1-1.6 3.6 0 5.9 1.6 2.3 4.3 3.3 5.6 2.3 1.6-1.3 1.6-3.9 0-6.2-1.4-2.3-4-3.3-5.6-2z"/></svg>
  </a>
</div>
...
![tens unit](/assets/pics/project_pics/dawn/stimulation.jpg)
...
- A\) Baseline: compute_features()'s accel/gyro output unchanged (54 features: mean/std/min/max/rms/zcr/dominant_freq/power_0_5hz/power_5_15hz per axis) in a single 60-second window.
- B\) Multi-horizon: (A)'s feature computation applied independently at three window lengths (30s/60s/180s), all ending at the same anticipation point (event_start - buffer_ms), concatenated into a 162-feature vector per sample
- C\) Enriched single-window: (A) + jerk (d(accel)/dt) time-domain stats (mean/std/min/max/rms/zcr per axis, 18 features) in a 60-second window, 72 total.
- D\) Enriched multi-horizon: (B) + jerk at each of the three window lengths, 216 features total (72 x 3, w30_/w60_/w180_ prefixed).
...
<video controls preload="metadata" style="width:100%; max-width:640px; margin: 1em 0; border-radius: 12px; box-shadow: 0 2px 16px rgba(0,0,0,0.15); cursor:pointer; background:#111;">
  <source src="/assets/pics/project_pics/dawn/newvalidation.mp4#t=0.1" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
![forest plot](/assets/pics/project_pics/dawn/forest_plot.png)
...
![population lambda sweep](/assets/pics/project_pics/dawn/lambda_sweep.png)
